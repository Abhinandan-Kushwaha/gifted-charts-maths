...
export interface extendedBarChartPropsType extends BarChartPropsTypeForWeb {
  parentWidth: number
  heightValue?: any // Animated.Value
  widthValue?: any // Animated.Value
  opacityValue?: any // Animated.Value
...
export const useBarChart = (props: extendedBarChartPropsType) => {
  ...
  let points2 = ''
  let arrowPoints = ''
  let selectedIndex = focusedBarIndex ?? -1
  ...
  const data: barDataItemNullSafe[] = initData()
