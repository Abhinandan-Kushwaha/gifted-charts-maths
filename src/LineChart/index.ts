...
export const useLineChart = (props: extendedLineChartPropsType) => {
  ...
  let pointerY2 = 0
  let pointerItem2 = null
  let pointerY3 = 0
  let pointerItem3 = null
  let pointerY4 = 0
  let pointerItem4 = null
  let pointerY5 = 0
  let pointerYsForDataSet = <number[]>[]
  let pointerItem5 = null
  let secondaryPointerY = 0
  let secondaryPointerItem = null
  let pointerItemsForSet = null
  let secondaryPointerItemsForSet = null

  let responderStartTime = 0
  ...
  let fillPoints4 = ''
  let fillPoints5 = ''
  let secondaryFillPoints = ''

  let pointsFromSet = <string[]>[]
  let fillPointsFromSet = <string[]>[]
  let arrowPointsFromSet = <string[]>[]

  let selectedIndex = props.focusedDataPointIndex ?? -1

  const setScrollX = (x: number) => {
    scrollX = x
  }
  const setArrow1Points = (x: string) => {
    arrow1Points = x
  }
  const setArrow2Points = (x: string) => {
    arrow2Points = x
  }
  const setArrow3Points = (x: string) => {
    arrow3Points = x
  }
  const setArrow4Points = (x: string) => {
    arrow4Points = x
  }
  const setArrow5Points = (x: string) => {
    arrow5Points = x
  }
  const setSecondaryArrowPoints = (x: string) => {
    secondaryArrowPoints = x
  }
  const setPointerIndex = (x: number) => {
    pointerIndex = x
  }
  const setPointerX = (x: number) => {
    pointerX = x
  }
  const setPointerY = (x: number) => {
    pointerY = x
  }
  const setPointerItem = (x: any) => {
    pointerItem = x
  }
  const setPointerY2 = (x: number) => {
    pointerY2 = x
  }
  const setPointerItem2 = (x: any) => {
    pointerItem2 = x
  }
  const setPointerY3 = (x: number) => {
    pointerY3 = x
  }
  const setPointerItem3 = (x: any) => {
    pointerItem3 = x
  }
  const setPointerY4 = (x: number) => {
    pointerY4 = x
  }
  const setPointerItem4 = (x: any) => {
    pointerItem4 = x
  }
  const setPointerY5 = (x: number) => {
    pointerY5 = x
  }
  const setPointerYsForDataSet = (x: number[]) => {
    pointerYsForDataSet = x
  }
  const setPointerItem5 = (x: any) => {
    pointerItem5 = x
  }
  const setSecondaryPointerY = (x: number) => {
    secondaryPointerY = x
  }
  const setSecondaryPointerItem = (x: any) => {
    secondaryPointerItem = x
  }
  const setPointerItemsForSet = (x: any) => {
    pointerItemsForSet = x
  }
  const setSecondaryPointerItemsForSet = (x: any) => {
    secondaryPointerItemsForSet = x
  }
  const setResponderStartTime = (x: number) => {
    responderStartTime = x
  }
  const setResponderActive = (x: boolean) => {
    responderActive = x
  }
  const setPoints = (x: string) => {
    points = x
  }
  const setPoints2 = (x: string) => {
    points2 = x
  }
  const setPoints3 = (x: string) => {
    points3 = x
  }
  const setPoints4 = (x: string) => {
    points4 = x
  }
  const setPoints5 = (x: string) => {
    points5 = x
  }
  const setSecondaryPoints = (x: string) => {
    secondaryPoints = x
  }
  const setFillPoints = (x: string) => {
    fillPoints = x
  }
  const setFillPoints2 = (x: string) => {
    fillPoints2 = x
  }
  const setFillPoints3 = (x: string) => {
    fillPoints3 = x
  }
  const setFillPoints4 = (x: string) => {
    fillPoints4 = x
  }
  const setFillPoints5 = (x: string) => {
    fillPoints5 = x
  }
  const setSecondaryFillPoints = (x: string) => {
    secondaryFillPoints = x
  }
  const setPointsFromSet = (x: string[]) => {
    pointsFromSet = x
  }
  const setFillPointsFromSet = (x: string[]) => {
    fillPointsFromSet = x
  }
  const setArrowPointsFromSet = (x: string[]) => {
    arrowPointsFromSet = x
  }
  const setSelectedIndex = (x: number) => {
    selectedIndex = x
  }

  const initialiseSelectedIndex = () => {
  ...
  const data = getSanitisedData(props.data, dataSanitisationProps)
  const data2 = getSanitisedData(props.data2, dataSanitisationProps)
  const data3 = getSanitisedData(props.data3, dataSanitisationProps)
  const data4 = getSanitisedData(props.data4, dataSanitisationProps)
  const data5 = getSanitisedData(props.data5, dataSanitisationProps)
  ...
  const initialiseSecondaryPoints = () => {
    let pp = ''
  ...
  const setSelectedLineNumber = (x: number) => {
    selectedLineNumber = x
  }
